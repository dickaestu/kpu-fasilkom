...
<table align="center">
  <tr>
    <td>
      <center>
        <img class="ml-auto" src="{{('assets/images/logoumb.jpeg')}}" width="160" height="140">
      </center>
    </td>
    <td>
      <center>
        ...
        <BR>
          ...
          <td>
            <center>
              <img class="ml-auto" src="{{('assets/images/yoga.jpeg')}}" width="140" height="140">
            </center>
          </td>
          </td>
        </tr>
  ...
  <table border="1" style="width:100%">
    <thead>
      <tr>
        ...
        <th  style="background-color: red;">Nama
        </th>
        <th  style="background-color: red;">Email
        </th>
        <th  style="background-color: red;">Jurusan
        </th>
      </tr>
    </thead>
    <tbody align="center">
